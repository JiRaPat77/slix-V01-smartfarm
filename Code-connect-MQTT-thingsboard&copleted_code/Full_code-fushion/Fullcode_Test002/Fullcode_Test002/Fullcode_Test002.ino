...
#define MQTT_USERNAME "KtkG2QXE1NOptp8SgJlY"
...
const unsigned long interval_1 = 5000;
...
//unsigned long nextCalc_temp;
//int CALC_INTERVAL_TEMP = 1000;
...
void TempHumi() {
  ...
  //  timer_temp = millis();
  //  if (timer_temp > nextCalc_temp) {
  //    nextCalc_temp = timer_temp + CALC_INTERVAL_TEMP;
...
//  mqtt.loop();
//  String dataJS_2 = "{\"UV value\":" + String(mapUV1, 3) + "}";
//  char json_2[300];
...
void Rain_loop() {
  ...
  if (timer_rain > nextCalc_rain) {
    ...
    //    if (timer_rain - lastMinuteMillis_rain >= 60000) {
...
void resetPico() {
  ...
  delay(1000); // Delay to allow serial monitor to print
