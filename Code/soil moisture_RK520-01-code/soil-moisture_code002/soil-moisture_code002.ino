...
float minValue_001 = -30.0;
float maxValue_001 = 70.0;
int val_1 = 0;
float Volt;
...
void loop()
{
 // long value = 0;
  ...
  Volt = value_soucre_T0 * (maxValue_001 - minValue_001) / 32767 + minValue_001;
  Serial.print(Volt);
  Serial.println("");
  ...
  Serial.print(T2_0 - 273.15,decimalPrecision);
  Serial.print(" Â°C");
...
/*
  ...
  Serial.print("V, Soil Moisture_1 : ");
  ...
  Serial.print(T2_1 - 273.15,decimalPrecision);
  Serial.print(" Â°C");
...
//  //////// soil moisture calc_2 ////////
  ...
  Serial.print("V, Soil Moisture_2 : ");
...
*/
  ...
  // int value_soucre_T0 = value_1_1;
  // Volt = value_soucre_T0 * (maxValue_001 - minValue_001) / 16260 + minValue_001;
  // Serial.print(Volt);
  // Serial.println("องศา");
  ...
  // d2 = c2 / BValue;
  // T2_2 = 1 / (a2-d2);
  // Serial.print("Soil Temp3 : ");
  // Serial.print(T2_2 - 273.15,decimalPrecision);
  // Serial.print(" Â°C");
...
//  //////// soil moisture calc_3 ////////
  ...
  // Serial.print("V, Soil Moisture_3 : ");
  ...
  // d3 = c3 / BValue;
  // T2_3 = 1 / (a3-d3);
  // Serial.print("Soil Temp4 : ");
  // Serial.print(T2_3 - 273.15,decimalPrecision);
  // Serial.print(" Â°C");
...
//  //////// soil moisture calc_4 ////////
  ...
  // Serial.print("V, Soil Moisture_4 : ");
  // Serial.print(SoilMoisture_3);
  // Serial.println("%");

  
  /*int valueTemp1 = value_1_3;
  const int analogMin = 0;
  const int analogMax = 32767;

  const int voltMin = 0;
  const int voltMax = 1024;
  const int TempMin = -30;
  const int TempMax = 70;


  float volt1 = map(valueTemp1, analogMin, analogMax, voltMin, voltMax);
  float temp1 = map(volt1, voltMin, voltMax, TempMin, TempMax);
  Serial.print("TempMap : ");
  Serial.println(temp1);*/
  
  

  /*int moisture_percentage = ( 100 - ( (value_2_3/32767.00) * 100 ) );
