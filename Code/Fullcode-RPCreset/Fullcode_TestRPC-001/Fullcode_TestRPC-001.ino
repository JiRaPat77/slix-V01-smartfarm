...
#define MQTT_USERNAME "oa1vhNejZyH43SOZ9Y76"
...
const unsigned long interval_1 = 30000 * 1;
...
void loop() {
  ...
  if (currentMillis_ - previousMillis_ >= interval_1) {
    ...
    mqtt.publish("v1/devices/me/telemetry", jsonString_3);
